...
|;
    ...
    if (@pending) {
        ...
        foreach (@pending) {
            my (
                $cddbid,     $artist,                  $album,           $current,
                $rip_status, $rip_percent,             $compress_status, $compress_percent,
                $rip_time,   $rip_predicted_remaining, $compress_time,   $compress_predicted_remaining
            ) = @$_;
