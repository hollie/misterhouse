...
sub PlaylistCtrl {
    ...
    $HTTP =
      $HTTP . "<td><a href='/music/MP3_WebPlaylist.pl?Refresh' target=MP3_Playlist><center><BIG> Refresh </BIG></center></td>\n";
    $HTTP = $HTTP
      . "<td><a href='/music/MP3_WebPlaylist.pl?ClearPlaylist' target=MP3_Playlist><center><BIG> Clear </BIG></center></td>\n";
    $HTTP =
      $HTTP . "<td><a href='/music/MP3_WebPlaylist.pl?Shuffle' target=MP3_Playlist><center><BIG> Shuffle </BIG></center></td>\n";
