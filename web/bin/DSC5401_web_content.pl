...
foreach (@ARGV) {
   print_log "WEB:DSC5401_web.pl: Receive alarm command $_" if $config_parms{debug} eq "DSC5401";
   ...
   if ( $DSCcommand eq "TstatBroadcast" ) {
      ...
      &::print_log("DSC5401 WEB: The system temperature broadcast is now $DSCarg");
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: The system temperature broadcast is now $DSCarg" );
   }
   ...
   if ( $DSCcommand eq "TimeBroadcast" ) {
      ...
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: The system time broadcast is now $DSCarg" );
   }
   ...
   if ( $DSCcommand eq "PartitionArmControl" ) {
      ...
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: Arming AWAY without access code" );
   }
   ...
   if ( $DSCcommand eq "PartitionArmControlStayArm" ) {
      ...
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: Arming STAY without access code" );
   }
   ...
   if ( $DSCcommand eq "SetDateTime" ) {
      ...
      &::print_log("DSC5401 WEB: Setting time on DSC panel to $TimeStamp (hhmmMMDDYY)");
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: Setting time on DSC panel to $TimeStamp (hhmmMMDDYY)" );
   }

   if ( $DSCcommand eq "PartitionArmControlWithCode" ) {
      $DSC->cmd( "PartitionArmControlWithCode", "1", "$DSCarg" ) if $DSCarg ne '';
      &::print_log("DSC5401 WEB: Arming system with access code");
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: Arming system with access code" );
   }
   ...
   if ( $DSCcommand eq "PartitionDisarmControl" ) {
      ...
      &::logit( "$main::config_parms{data_dir}/logs/DSC5401.$main::Year_Month_Now.log", "DSC5401 WEB: Disarming system with access code" );
   }
...
$html .= &my_header( "System status ($DSC->{partition_status}{1})", "$StatusColor" ), "\n";
...
for ( 1 .. $size ) {
   ...
   if ( $name[$_] ) {
      ...
      $Str .= "  <FONT COLOR=\"#800000\">($status)</FONT>" if $status ne "restored";

      $html .= qq[    <td width=33% align='left'>];
      $html .= qq[ <img border=0 name="ZONE_${_}" src="/graphics/green_bullet.gif">&nbsp $Str</td>\n] if $status eq "restored";
      $html .= qq[ <img border=0 name="ZONE_${_}"src="/graphics/red_bullet.gif">&nbsp $Str</td>\n] if $status ne "restored";
   }
   else {
      $Str  .= "Not Used";
      $html .= qq[    <td width=33% align='left' BGCOLOR='#DDDDDD'>];
      $html .= qq[ <img border=0 src="/graphics/black_bullet.gif">&nbsp $Str</td>\n] if $Str =~ /Not Used/;
   }
...
$html .= qq[<input type="submit"  name="TstatBroadcast"  value="off" style="width: 30; border: 1px solid silver;">] if $state eq 'on';
$html .= qq[<input type="submit"  name="TstatBroadcast"  value="on" style="width: 40; border: 1px solid silver;">] if $state eq 'off';
$html .= qq[</td>\n];
...
$html .= qq[<input type="submit"  name="TimeBroadcast"  value="off"style="width: 30; border: 1px solid silver;">] if $state eq 'on';
$html .= qq[<input type="submit"  name="TimeBroadcast"  value="on" style="width: 40; border: 1px solid silver;">] if $state eq 'off';
$html .= qq[</td>\n];
$html .= qq[  </tr>\n\n];
...
$html .= qq[<input type="submit"  name="PartitionEventMsg"  value="On"  style="width: 50; border: 1px solid silver;">];
$html .= qq[<input type="submit"  name="PartitionEventMsg"  value="Off" style="width: 50; border: 1px solid silver;">];
$html .= qq[</td>\n];
...
$html .= qq[<input type="submit"  name="ZoneEventMsg"  value="On"  style="width: 50; border: 1px solid silver;">];
$html .= qq[<input type="submit"  name="ZoneEventMsg"  value="Off" style="width: 50; border: 1px solid silver;">];
$html .= qq[</td>\n];
$html .= qq[  </tr>\n\n];
...
#$html .= qq[    <td width=50%>];
$html .= qq[    <td width=50%>];
$html .= qq[<input type="submit"  name="SetDateTime"  value="Set time & date" style="width: 100; border: 1px solid silver;">];
$html .= qq[</td>\n];

# enable verbose logging
$html .= qq[    <td width=50%>Verbose arming control&nbsp;&nbsp;];
$html .= qq[<input type="submit"  name="VerboseArmingControl"  value="On"  style="width: 50; border: 1px solid silver;">];
$html .= qq[<input type="submit"  name="VerboseArmingControl"  value="Off" style="width: 50; border: 1px solid silver;">];
...
$html .= qq[<input type="submit"  name="PartitionArmControl"  value="Arm away" style="width: 60; border: 1px solid silver;">];
$html .= qq[</td>\n];
$html .= qq[    <td width=50%>System ];
$html .= qq[<input type="submit"  name="PartitionArmControlStayArm"  value="Arm stay" style="width: 60; border: 1px solid silver;">];
$html .= qq[</td>\n];
$html .= qq[  </tr>\n\n];
...
$html .= qq[       <input type="password"  name="PartitionArmControlWithCode" onChange="this.form.submit()" style="width: 40px; border: 2px solid silver;">\n];
$html .= qq[    </td>\n];

# Disarm system with access code
$html .= qq[    <td width=50%>Disarm with access code\n];
$html .= qq[       <input type="password"  name="PartitionDisarmControl"  size=6 onChange="this.form.submit()" style="width: 40px; border: 2px solid silver;">\n];
$html .= qq[    </td>\n];
...
$html .= qq[<br><form method='get' onsubmit=submit() action='DSC5401_web_content.pl' enctype='application/x-www-form-urlencoded'>Refresh: \n];
