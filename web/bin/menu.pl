...
sub html_top {
    ...
    $html .=
      "<td align=left>" . &html_file( undef, '../web/bin/set_cookie.pl', 'menu_keys&&<b>Keyboard Control</b>', 1 ) . "</td>\n"
      if $menu_keys_allowed;
    $html .= "<td align=left>" . &html_file( undef, '../web/bin/set_cookie.pl', 'menu_buttons&&<b>Buttons</b>', 1 ) . "</td>\n";
    $html .=
      "<td align=left>" . &html_file( undef, '../web/bin/set_cookie.pl', 'webmute&&<b>Webmute</b>&&&&/bin/menu.pl', 1 ) . "</td>\n";
