...
sub PrintAllRecords {
    ...
    if ($showCompleted) {
        print
          " <input type='submit' value='Hide Completed' onclick=\"self.location='$scriptName?vsSORT=$sortField&vsPS=$pageSize';return false\">\n";
    }
    else {
        print
          " <input type='submit' value='Show Completed' onclick=\"self.location='$scriptName?vsSORT=$sortField&vsSC=1&vsPS=$pageSize';return false\">\n";
    }
    print "</td></tr></table>\n";
