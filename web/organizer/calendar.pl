...
sub PrintMonth {
    ...
    if ($showDayDetails) {
        print " <font size='1'>[<a href='$scriptName?vsSD=0&vsMA=$showforAudrey&vsMonth=$month&vsYear=$year&"
          . $ia7_suffix
          . "'>Hide Details</a>]</font>\n";
    }
    else {
        print " <font size='1'>[<a href='$scriptName?vsSD=1&vsMA=$showforAudrey&vsMonth=$month&vsYear=$year&"
          . $ia7_suffix
          . "'>Show Details</a>]</font>\n";
    }
