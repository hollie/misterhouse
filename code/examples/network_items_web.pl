...
#		}
   ...
   $html_hdr .= "<table width=100% cellspacing=2><tbody><font face=COURIER size=2><tr id='resultrow' bgcolor='#9999CC' class='wvtheader'><th align='left'>Network Device</th><th align='left'>Status</th><th align='left'>Control ON</th><th align='left'>Control OFF</th>\n";
