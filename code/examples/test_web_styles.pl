...
$v_test_dropdown = new Voice_Cmd('Set dropdown thermostat to [65,66,67,68,69,70,71,72,73,74,75,76,78,79,80]');
...
$v_test_radio = new Voice_Cmd('Set radio thermostat to [65,66,67,68,69,70,71,72,73,74,75,76,78,79,80]');
...
$v_test_url = new Voice_Cmd('Set url thermostat to [65,66,67,68,69,70,71,72,73,74,75,76,78,79,80]');
