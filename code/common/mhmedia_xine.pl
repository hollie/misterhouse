...
my $mediahost =
  $config_parms{media_server_host_port}; #@ the server (localhost)  and port (6789) for the player
$mediahost = "localhost:6789" unless $mediahost;

my $mediaPlaylist =
  $config_parms{media_server_playlist}; #@full path to the palylist including the name
