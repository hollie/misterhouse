...
if ($Reload) { 
	$actiontec_username = $config_parms{'actiontec_username'} if $config_parms{'actiontec_username'};
	$actiontec_password = $config_parms{'actiontec_password'} if $config_parms{'actiontec_password'};
	$actiontec_download_mbps = $config_parms{'actiontec_download_mbps'} if $config_parms{'actiontec_download_mbps'};
	$actiontec_upload_mbps = $config_parms{'actiontec_upload_mbps'} if $config_parms{'actiontec_upload_mbps'};
	...
	$actiontec_host = $config_parms{'actiontec_host'} if $config_parms{'actiontec_host'}; 
