...
# build the url from existing init variables if the values have been left blank
	...
	$weatherbug_units = "1";
	$weatherbug_units = "0" if ($config_parms{weather_uom_temp} ne "C");
	}
# complete the url for the rss feed
	my $weatherbug_url;
	my $key = "A".(((149*37*2*5*37+23)*9*17)+10)*3*5;
...
# Define the url that is used to fetch the forecast
	...
	$weatherbug_url="http://api.wxbug.net/getForecastRSS.aspx?ACode=".$key."&lat=".$weatherbug_latitude."&long=".$weatherbug_longitude."&unittype=".$weatherbug_units if ($weatherbug_latitude ne "" and $weatherbug_longitude ne "");
	# 2nd Priority use the zipcode form if the zipcode is available
	$weatherbug_url="http://api.wxbug.net/getForecastRSS.aspx?ACode=".$key."&zipcode=".$weatherbug_zipcode."&unittype=".$weatherbug_units if ($weatherbug_zipcode ne "");
	# First Priority so test last - and use the city code if assigned
	$weatherbug_url="http://api.wxbug.net/getForecastRSS.aspx?ACode=".$key."&citycode=".$weatherbug_citycode."&unittype=".$weatherbug_units if ($weatherbug_citycode ne "");
...
# Need to add a process to get the live observations
        # use the lattitude and longitude form if they are available
        $weatherbug_url="http://api.wxbug.net/getLiveWeatherRSS.aspx?ACode=".$key."&lat=".$weatherbug_latitude."&long=".$weatherbug_longitude."&unittype=".$weatherbug_units if ($weatherbug_latitude ne "" and $weatherbug_longitude ne "");
        # 2nd Priority use the zipcode form if the zipcode is available
        $weatherbug_url="http://api.wxbug.net/getLiveWeatherRSS.aspx?ACode=".$key."&zipcode=".$weatherbug_zipcode."&unittype=".$weatherbug_units if ($weatherbug_zipcode ne "");
        # First Priority so test last - and use the city code if assigned
        $weatherbug_url="http://api.wxbug.net/getLiveWeatherRSS.aspx?ACode=".$key."&citycode=".$weatherbug_citycode."&unittype=".$weatherbug_units if ($weatherbug_citycode ne "");
	logit("$config_parms{data_dir}/web/weatherbug_debug",$weatherbug_url,13,0) if($Debug{weatherbug});
# Define the new process item that fetchs the RSS feed for the location
...
my @wxbug_conditions = ("Clear", "Cloudy", "Partly Cloudy", "Partly Cloudy", "Partly Sunny", "Rain", "Thunderstorms", "Sunny", "Snow", "Flurries", "Unknown", "Chance of Snow", "Snow", "Cloudy", "Rain", "Chance of Rain", "Partly Cloudy", "Fair", "Thunderstorms", "Chance of Flurry", "Chance of Rain", "Chance of Sleet", "Chance of Storms", "Hazy", "Mostly Cloudy", "Sleet", "Mostly Sunny", "Chance of Flurry", "Chance of Sleet ", "Chance of Snow", "Chance of Storms", "Clear", "Flurries", "Hazy", "Mostly Cloudy ", "Fair", "Sleet", "Unknown", "Chance of Rain Showers", "Chance of Snow Showers", "Snow Showers", "Rain Showers", "Chance of Rain Showers", "Chance of Snow Showers", "Snow Showers", "Rain Showers", "Freezing Rain", "Freezing Rain", "Chance Freezing Rain", "Chance Freezing Rain", "Windy", "Fog", "Scattered Showers", "Scattered Thunderstorms", "Light Snow", "Chance of Light Snow", "Frozen Mix", "Chance of Frozen Mix", "Drizzle", "Chance of Drizzle", "Freezing Drizzle", "Chance of Freezing Drizzle", "Heavy Snow", "Heavy Rain", "Hot and Humid", "Very Hot", "Increasing Clouds", "Clearing", "Mostly Cloudy", "Very Cold", "Mostly Clear", "Increasing Clouds", "Clearing", "Mostly Cloudy", "Very Cold", "Warm and Humid", "Nowcast", "Headline", "30% Chance of Snow", "40% Chance of Snow", "50% Chance of Snow", "30% Chance of Rain", "40% Chance of Rain", "50% Chance of Rain", "30% Chance of Flurry", "40% Chance of Flurry", "50% Chance of Flurry", "30% Chance of Rain", "40% Chance of Rain", "50% Chance of Rain", "30% Chance of Sleet", "40% Chance of Sleet", "50% Chance of Sleet", "30% Chance of Storms", "40% Chance of Storms", "50% Chance of Storms", "30% Chance of Flurry", "40% Chance of Flurry", "50% Chance of Flurry", "30% Chance of Sleet", "40% Chance of Sleet", "50% Chance of Sleet", "30% Chance of Snow", "40% Chance of Snow", "50% Chance of Snow", "30% Chance of Storms", "40% Chance of Storms", "50% Chance of Storms", "30% Chance Rain Shower", "40% Chance Rain Shower", "50% Chance Rain Shower", "30% Chance Snow Shower", "40% Chance Snow Shower", "50% Chance Snow Shower", "30% Chance Rain Shower", "40% Chance Rain Shower", "50% Chance Rain Shower", "30% Chance Snow Shower", "40% Chance Snow Shower", "50% Chance Snow Shower", "30% Chance Freezing Rain", "40% Chance Freezing Rain", "50% Chance Freezing Rain", "30% Chance Freezing Rain", "40% Chance Freezing Rain", "50% Chance Freezing Rain", "30% Chance of Light Snow", "40% Chance of Light Snow", "50% Chance of Light Snow", "30% Chance of Frozen Mix", "40% Chance of Frozen Mix", "50% Chance of Frozen Mix", "30% Chance of Drizzle", "40% Chance of Drizzle", "50% Chance of Drizzle", "30% Chance Freezing Drizzle", "40% Chance Freezing Drizzle", "50% Chance Freezing Drizzle", "Chance of Snow", "Chance of Rain", "Chance of Flurry", "Chance of Rain", "Chance of Sleet", "Chance of Storms", "Chance of Flurry", "Chance of Sleet", "Chance of Snow", "Chance of Storms", "Chance Rain Shower", "Chance Snow Shower", "Chance Rain Shower", "Chance Snow Shower", "Chance Freezing Rain", "Chance Freezing Rain", "Chance of Light Snow", "Chance of Frozen Mix", "Chance of Drizzle", "Chance Freezing Drizzle", "windy", "Foggy", "Light Snow", "Frozen Mix", "Drizzle", "Heavy Rain", "Chance of Frozen Mix", "Chance of Drizzle", "Chance of Frozen Drizzle", "30% Chance Drizzle", "30% Chance Frozen Drizzle", "30% Chance Frozen Mix", "40% Chance Drizzle", "40% Chance Fozen Drizzle", "40% Chance Frozen Mix", "40% Chance Drizzle", "40% Chance Frozen Drizzle", "40% Chance Frozen Mix", "Chance of Light Snow");
# conditions simplified for rain and snow
my @wxbug_precip_type = ("Clear", "Overcast", "Overcast", "Overcast", "Clear", "Rain", "Rain", "Clear", "Snow", "Snow", "Clear", "Snow", "Snow", "Overcast", "Rain", "Rain", "Clear", "Clear", "Rain", "Snow", "Rain", "Ice", "Rain", "Overcast", "Overcast", "Ice", "Clear", "Snow", "Ice", "Snow", "Rain", "Clear", "Snow", "Overcast", "Overcast", "Clear", "Ice", "Clear", "Rain", "Snow", "Snow", "Rain", "Rain", "Snow", "Snow", "Rain", "Ice", "Ice", "Ice", "Ice", "Clear", "Overcast", "Rain", "Rain", "Snow", "Snow", "Ice", "Ice", "Rain", "Rain", "Ice", "Rain", "Snow", "Rain", "Clear", "Clear", "Overcast", "Clear", "Overcast", "Clear", "Clear", "Overcast", "Clear", "Overcast", "Clear", "Clear", "Clear", "Clear", "Snow", "Snow", "Snow", "Rain", "Rain", "Rain", "Snow", "Snow", "Snow", "Rain", "Rain", "Rain", "Ice", "Ice", "Ice", "Rain", "Rain", "Rain", "Snow", "Snow", "Snow", "Ice", "Ice", "Ice", "Snow", "Snow", "Snow", "Rain", "Rain", "Rain", "Rain", "Rain", "Rain", "Snow", "Snow", "Snow", "Rain", "Rain", "Rain", "Snow", "Snow", "Snow", "Ice", "Ice", "Ice", "Ice", "Ice", "Ice", "Snow", "Snow", "Snow", "Ice", "Ice", "Ice", "Rain", "Rain", "Rain", "Ice", "Ice", "Ice", "Snow", "Rain", "Snow", "Rain", "Ice", "Rain", "Snow", "Ice", "Snow", "Rain", "Rain", "Snow", "Rain", "Snow", "Ice", "Ice", "Snow", "Ice", "Rain", "Ice", "Clear", "Overcast", "Snow", "Mixed", "Rain", "Rain", "Mixed", "Rain", "Mixed", "Rain", "Rain", "", "Rain", "Mixed", "Mixed", "Rain", "Mixed", "Mixed", "Snow");
# inferred amount of precipatation
my @wxbug_precip_ammount = ("None", "None", "None", "None", "None", "Moderate", "Moderate", "None", "Moderate", "Light", "None", "Light", "Moderate", "None", "Moderate", "Light", "None", "None", "Moderate", "Light", "Light", "Light", "Light", "None", "None", "Light", "None", "Light", "Light", "Light", "Light", "None", "Light", "None", "None", "None", "Light", "None", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Moderate", "Moderate", "Light", "Light", "None", "None", "Light", "Light", "Light", "Light", "Light", "Light", "Trace", "Trace", "Trace", "Trace", "Heavy", "Heavy", "None", "None", "None", "None", "None", "None", "None", "None", "None", "None", "None", "None", "None", "None", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Light", "Trace", "Trace", "None", "None", "Light", "Light", "Trace", "Heavy", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace", "Trace");
# noloop=stop
# -----------------------------------------------------------------------
# set the triggers for calling the updated forecast
if ($Reload) {
	&trigger_set('($New_Minute and $Minute == 55) or $Reload', "run_voice_cmd 'Weatherbug getforecast'", 'NoExpire', 'Update weather forecast via WeatherBug')
	  unless &trigger_get('Update weather forecast via WeatherBug');
	&trigger_set('($New_Minute and $Minute == 5) or $Reload', "run_voice_cmd 'Weatherbug LiveWeather'", 'NoExpire', 'Update current weather via WeatherBug')
...
if (done_now $p_weather_weatherbug_citycode) {
	...
	# Check that the file is valid by looking for locations tag
        ...
        # This splits the detailed forecasts into the forecast items
                @weatherbug_locations = split (/<aws:location|\/>/,$weatherbug_xml);
...
if (done_now $p_weather_weatherbug_forecast) {
	...
	foreach my $forecast ($root->descendants("aws:forecast")) {
		...
		logit("$config_parms{data_dir}/web/weatherbug_debug",$forecast->print,13,0) if($Debug{weatherbug});
		...
		if($Debug{weatherbug}){
			my $temp = 'Forecast#='.$fcast_counter.' day='.$f_day.' cond='.$f_cond.' chance='.$f_chance.' humidity='.$f_humidity.' dewpoint='.$f_dewpoint.' comfort='.$f_comfort.' windspeed='.$f_windspeed.' winddir='.$f_winddir.' high='.$f_high.' low='.$f_low.' conditions='.$f_conditions.' precip_type='.$f_precip_type.' precip_ammount='.$f_precip_ammount.' Published='.$f_date.' valid for '.$f_timetolive.' minutes.';
