        ...
        my @wxbug_precip_type = (
            "Clear",    "Overcast", "Overcast", "Overcast", "Clear",    "Rain",     "Rain",  "Clear",
            "Snow",     "Snow",     "Clear",    "Snow",     "Snow",     "Overcast", "Rain",  "Rain",
            "Clear",    "Clear",    "Rain",     "Snow",     "Rain",     "Ice",      "Rain",  "Overcast",
            "Overcast", "Ice",      "Clear",    "Snow",     "Ice",      "Snow",     "Rain",  "Clear",
            "Snow",     "Overcast", "Overcast", "Clear",    "Ice",      "Clear",    "Rain",  "Snow",
            "Snow",     "Rain",     "Rain",     "Snow",     "Snow",     "Rain",     "Ice",   "Ice",
            "Ice",      "Ice",      "Clear",    "Overcast", "Rain",     "Rain",     "Snow",  "Snow",
            "Ice",      "Ice",      "Rain",     "Rain",     "Ice",      "Rain",     "Snow",  "Rain",
            "Clear",    "Clear",    "Overcast", "Clear",    "Overcast", "Clear",    "Clear", "Overcast",
            "Clear",    "Overcast", "Clear",    "Clear",    "Clear",    "Clear",    "Snow",  "Snow",
            "Snow",     "Rain",     "Rain",     "Rain",     "Snow",     "Snow",     "Snow",  "Rain",
            "Rain",     "Rain",     "Ice",      "Ice",      "Ice",      "Rain",     "Rain",  "Rain",
            "Snow",     "Snow",     "Snow",     "Ice",      "Ice",      "Ice",      "Snow",  "Snow",
            "Snow",     "Rain",     "Rain",     "Rain",     "Rain",     "Rain",     "Rain",  "Snow",
            "Snow",     "Snow",     "Rain",     "Rain",     "Rain",     "Snow",     "Snow",  "Snow",
            "Ice",      "Ice",      "Ice",      "Ice",      "Ice",      "Ice",      "Snow",  "Snow",
            "Snow",     "Ice",      "Ice",      "Ice",      "Rain",     "Rain",     "Rain",  "Ice",
            "Ice",      "Ice",      "Snow",     "Rain",     "Snow",     "Rain",     "Ice",   "Rain",
            "Snow",     "Ice",      "Snow",     "Rain",     "Rain",     "Snow",     "Rain",  "Snow",
            "Ice",      "Ice",      "Snow",     "Ice",      "Rain",     "Ice",      "Clear", "Overcast",
            "Snow",     "Mixed",    "Rain",     "Rain",     "Mixed",    "Rain",     "Mixed", "Rain",
            "Rain",     "",         "Rain",     "Mixed",    "Mixed",    "Rain",     "Mixed", "Mixed",
            "Snow"
        );

        # inferred amount of precipatation
        my @wxbug_precip_ammount = (
            "None",     "None",  "None",     "None",  "None",     "Moderate", "Moderate", "None",
            "Moderate", "Light", "None",     "Light", "Moderate", "None",     "Moderate", "Light",
            "None",     "None",  "Moderate", "Light", "Light",    "Light",    "Light",    "None",
            "None",     "Light", "None",     "Light", "Light",    "Light",    "Light",    "None",
            "Light",    "None",  "None",     "None",  "Light",    "None",     "Light",    "Light",
            "Light",    "Light", "Light",    "Light", "Light",    "Light",    "Moderate", "Moderate",
            "Light",    "Light", "None",     "None",  "Light",    "Light",    "Light",    "Light",
            "Light",    "Light", "Trace",    "Trace", "Trace",    "Trace",    "Heavy",    "Heavy",
            "None",     "None",  "None",     "None",  "None",     "None",     "None",     "None",
            "None",     "None",  "None",     "None",  "None",     "None",     "Light",    "Light",
            ...
            "Light",    "Light", "Light",    "Light", "Light",    "Light",    "Light",    "Light",
            "Light",    "Light", "Light",    "Light", "Light",    "Light",    "Light",    "Light",
            "Light",    "Light", "Light",    "Light", "Trace",    "Trace",    "Trace",    "Trace",
            "Trace",    "Trace", "Light",    "Light", "Light",    "Light",    "Light",    "Light",
            "Light",    "Light", "Light",    "Light", "Light",    "Light",    "Light",    "Light",
            "Light",    "Light", "Light",    "Light", "Trace",    "Trace",    "None",     "None",
            "Light",    "Light", "Trace",    "Heavy", "Trace",    "Trace",    "Trace",    "Trace",
        ...
        if ( done_now $p_weather_weatherbug_forecast) {
            ...
            logit( "$config_parms{data_dir}/web/weatherbug_debug", $f_date . ' for ' . $f_timetolive . ' minutes', 13, 0 )
              if ( $Debug{weatherbug} );
