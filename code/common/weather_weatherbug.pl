...
$p_weather_weatherbug_forecast =
  new Process_Item(qq{get_url -quiet "$weatherbug_url" "$weatherbug_file"});
...
# Define the new process item that fetchs the RSS feed for the location
$p_weather_weatherbug_liveweather =
  new Process_Item(qq{get_url -quiet "$weatherbug_url" "$weatherbug_obs_file"});
...
my @wxbug_precip_type = (
    "Clear",    "Overcast", "Overcast", "Overcast", "Clear",    "Rain",
    "Rain",     "Clear",    "Snow",     "Snow",     "Clear",    "Snow",
    "Snow",     "Overcast", "Rain",     "Rain",     "Clear",    "Clear",
    "Rain",     "Snow",     "Rain",     "Ice",      "Rain",     "Overcast",
    "Overcast", "Ice",      "Clear",    "Snow",     "Ice",      "Snow",
    "Rain",     "Clear",    "Snow",     "Overcast", "Overcast", "Clear",
    "Ice",      "Clear",    "Rain",     "Snow",     "Snow",     "Rain",
    "Rain",     "Snow",     "Snow",     "Rain",     "Ice",      "Ice",
    "Ice",      "Ice",      "Clear",    "Overcast", "Rain",     "Rain",
    "Snow",     "Snow",     "Ice",      "Ice",      "Rain",     "Rain",
    "Ice",      "Rain",     "Snow",     "Rain",     "Clear",    "Clear",
    "Overcast", "Clear",    "Overcast", "Clear",    "Clear",    "Overcast",
    "Clear",    "Overcast", "Clear",    "Clear",    "Clear",    "Clear",
    "Snow",     "Snow",     "Snow",     "Rain",     "Rain",     "Rain",
    "Snow",     "Snow",     "Snow",     "Rain",     "Rain",     "Rain",
    "Ice",      "Ice",      "Ice",      "Rain",     "Rain",     "Rain",
    ...
    "Snow",     "Snow",     "Snow",     "Ice",      "Ice",      "Ice",
    "Rain",     "Rain",     "Rain",     "Ice",      "Ice",      "Ice",
    "Snow",     "Rain",     "Snow",     "Rain",     "Ice",      "Rain",
    "Snow",     "Ice",      "Snow",     "Rain",     "Rain",     "Snow",
    "Rain",     "Snow",     "Ice",      "Ice",      "Snow",     "Ice",
    "Rain",     "Ice",      "Clear",    "Overcast", "Snow",     "Mixed",
    "Rain",     "Rain",     "Mixed",    "Rain",     "Mixed",    "Rain",
    "Rain",     "",         "Rain",     "Mixed",    "Mixed",    "Rain",
    "Mixed",    "Mixed",    "Snow"
);
...
my @wxbug_precip_ammount = (
    ...
    "Moderate", "None",  "Moderate", "Light", "None",     "Light",
    "Moderate", "None",  "Moderate", "Light", "None",     "None",
    "Moderate", "Light", "Light",    "Light", "Light",    "None",
    "None",     "Light", "None",     "Light", "Light",    "Light",
    "Light",    "None",  "Light",    "None",  "None",     "None",
    "Light",    "None",  "Light",    "Light", "Light",    "Light",
    "Light",    "Light", "Light",    "Light", "Moderate", "Moderate",
    "Light",    "Light", "None",     "None",  "Light",    "Light",
    "Light",    "Light", "Light",    "Light", "Trace",    "Trace",
    "Trace",    "Trace", "Heavy",    "Heavy", "None",     "None",
    ...
    "Light",    "Light", "Light",    "Light", "Light",    "Light",
    "Light",    "Light", "Light",    "Light", "Light",    "Light",
    "Trace",    "Trace", "None",     "None",  "Light",    "Light",
    "Trace",    "Heavy", "Trace",    "Trace", "Trace",    "Trace",
    "Trace",    "Trace", "Trace",    "Trace", "Trace",    "Trace",
    "Trace",    "Trace", "Trace"
);
...
if ( done_now $p_weather_weatherbug_liveweather) {
    ...
    $wxbug_pass{WindAvgDir} =
      &Weather_Common::convert_wind_dir_abbr_to_num($f_winddirectionavg);
