...
speak("rooms=all voice=Claire The plants want to be watered.  They gave me the following message:" .
...
&speak_anniversary(1953, 'Mal & Beth',   'anniversary') if (time_cron('0 8,10,14,18,22  4 11 *'));
&speak_anniversary(1958, 'John & Donna', 'anniversary') if (time_cron('0 8,10,14,18,22 31  8 *'));
&speak_anniversary(1928, 'Mal',          'birthday')    if (time_cron('0 8,10,14,18,22  8  6 *'));
&speak_anniversary(1932, 'Beth',         'birthday')    if (time_cron('0 8,10,14,18,22 18  5 *'));
&speak_anniversary(1934, 'Johnny',       'birthday')    if (time_cron('0 8,10,14,18,22  7  9 *'));
&speak_anniversary(1940, 'Donna',        'birthday')    if (time_cron('0 8,10,14,18,22  1  6 *'));
&speak_anniversary(1959, 'Laurie',       'birthday')    if (time_cron('0 8,10,14,18,22 22  4 *'));
&speak_anniversary(1958, 'Bruce',        'birthday')    if (time_cron('0 8,10,14,18,22  8  7 *'));
