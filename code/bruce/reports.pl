...
if (said $v_report_weblog or time_now '5:05 AM') {
    ...
    set   $p_report_weblog "report_weblog -ignore none -outdir $config_parms{data_dir}/logs -runid mh_month $config_parms{data_dir}/logs/server_http.$Year_Month_Now.log";
