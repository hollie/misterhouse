...
if ( my $state = said $v_MBM_sensors) {
    ...
    $line .=
      sprintf( "Temp 1 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t1->name, $MBM_t1->state, $MBM_t1->high, $MBM_t1->low );
    $line .=
      sprintf( "Temp 2 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t2->name, $MBM_t2->state, $MBM_t2->high, $MBM_t2->low );
    $line .=
      sprintf( "Temp 3 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t3->name, $MBM_t3->state, $MBM_t3->high, $MBM_t3->low );
    $line .=
      sprintf( "Temp 4 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t4->name, $MBM_t4->state, $MBM_t4->high, $MBM_t4->low );
    $line .=
      sprintf( "Temp 5 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t5->name, $MBM_t5->state, $MBM_t5->high, $MBM_t5->low );
    $line .=
      sprintf( "Temp 6 name %-12.12s is %3d max %3d min %3d<br>", $MBM_t6->name, $MBM_t6->state, $MBM_t6->high, $MBM_t6->low );
    ...
    $line .=
      sprintf( "Fan 1  name %-12.12s is %4d max %4d min %4d<br>", $MBM_f1->name, $MBM_f1->state, $MBM_f1->high, $MBM_f1->low );
    $line .=
      sprintf( "Fan 2  name %-12.12s is %4d max %4d min %4d<br>", $MBM_f2->name, $MBM_f2->state, $MBM_f2->high, $MBM_f2->low );
    $line .=
      sprintf( "Fan 3  name %-12.12s is %4d max %4d min %4d<br>", $MBM_f3->name, $MBM_f3->state, $MBM_f3->high, $MBM_f3->low );
    $line .=
      sprintf( "Fan 4  name %-12.12s is %4d max %4d min %4d<br>", $MBM_f4->name, $MBM_f4->state, $MBM_f4->high, $MBM_f4->low );
    respond "$line";
}
##
