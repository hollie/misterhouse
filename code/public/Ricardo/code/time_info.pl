...
respond "El sol sale hoy a las $Time_Sunrise, la puesta de sol es a las $Time_Sunset."
  if said $v_sun_set;

speak "Aviso, el sol está saliendo ahora a las " . say_time($Time_Sunrise)
  if time_now $Time_Sunrise and !$Save{sleeping_parents};
speak "app=notice Aviso, el sol se está poniendo ahora a las " . say_time($Time_Sunset)
