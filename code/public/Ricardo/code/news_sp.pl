...
# Sections names
my %Sections_names = (
    'Hoy',           'Hoy es noticia', 'Nacional', 'Nacional',
    'Internacional', 'Internacional',  'Deportes', "Deportes \/ Segundosfuera",
    'Sociedad',      'Sociedad',       'Finanzas', "Finanzas \/ Basefinanciera",
    'Tecnología',    'Tecnología',     'Ciencia',  'Ciencia',
    'Cultura',       'Cultura',
);
