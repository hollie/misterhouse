...
run_voice_cmd 'Set the house mp3 player to pause' if state_now $mp3remote eq 'mp3-pause';
run_voice_cmd 'Set the house mp3 player to play' if state_now $mp3remote eq 'mp3-play';
run_voice_cmd 'Set the house mp3 player to Next Song' if state_now $mp3remote eq 'mp3-fwd';
run_voice_cmd 'Set the house mp3 player to Previous Song' if state_now $mp3remote eq 'mp3-back';
run_voice_cmd 'Set the house mp3 player to Volume Up' if state_now $mp3remote eq 'mp3-volup';
run_voice_cmd 'Set the house mp3 player to Volume Down' if state_now $mp3remote eq 'mp3-voldn';
...
run_voice_cmd 'Set house mp3 player to playlist portishead' if state_now $mp3remote eq 'mp3-1'; 
run_voice_cmd 'Set house mp3 player to playlist julielondon' if state_now $mp3remote eq 'mp3-2'; 
run_voice_cmd 'Set house mp3 player to playlist ellafitzgerald' if state_now $mp3remote eq 'mp3-3'; 
run_voice_cmd 'Set house mp3 player to playlist sarahvaughn' if state_now $mp3remote eq 'mp3-4'; 
run_voice_cmd 'Set house mp3 player to playlist assortedjazz' if state_now $mp3remote eq 'mp3-5'; 
run_voice_cmd 'Set house mp3 player to playlist mozart' if state_now $mp3remote eq 'mp3-6'; 