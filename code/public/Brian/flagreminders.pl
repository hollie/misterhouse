...
if ($Day > 0 and $Day < 7) {
	...
	if (time_cron('20 17 * 11 2')) {speak "Notice: Please take the flag in."};
}
...
if ($Day > 7 and $Day < 14) {
	...
	if (time_cron('20 17 * 10 1')) {speak "Notice: Please take the flag in."};
}
...
if ($Day > 21 and $Day < 28) {
	...
	if (time_cron('20 17 * 11 4')) {speak "Notice: Please take the flag in."};
}