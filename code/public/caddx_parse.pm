        ...
        sub parse_01H {
            ...
            $datum = join( '', @msgb[ 2 .. 5 ] );
            push( @msgdata,
                [ '2-5:', 'Firmware version (i.e. 1.00 (ASCII))', $datum ] );
            $datum = $msgb[6];
            push( @msgdata,
                [ '6:', 'Supported transition message flags (1)', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[6], '0' );
            push( @msgdata, [ '6:0', '(00h) Reserved', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[6], '1' );
            push( @msgdata,
                [ '6:1', '(01h) Interface Configuration Message', $datum ] );
            ...
            $datum = $msgb[7];
            push( @msgdata,
                [ '7:', 'Supported transition message flags (2)', $datum ] );
            ...
            $datum = $msgb[9];
            push( @msgdata,
                [ '9:', 'Supported request / command flags (2)', $datum ] );
            ...
            $datum = $msgb[10];
            push( @msgdata,
                [ '10:', 'Supported request / command flags (3)', $datum ] );
            ...
            push( @msgdata,
                [ '10:2', '(32h) User Information Request with PIN', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[10], '3' );
            push(
                @msgdata,
                [
                    '10:3', '(33h) User Information Request without PIN', $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[10], '4' );
            push( @msgdata,
                [ '10:4', '(34h) Set User Code Command with PIN', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[10], '5' );
            push( @msgdata,
                [ '10:5', '(35h) Set User Code Command without PIN', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[10], '6' );
            push(
                @msgdata,
                [
                    '10:6', '(36h) Set User Authorization Command with PIN',
                    $datum
                ]
            );
            ...
            push(
                @msgdata,
                [
                    '10:7', '(37h) Set User Authorization Command without PIN',
                    $datum
                ]
            );
            $datum = $msgb[11];
            push( @msgdata,
                [ '11:', 'Supported request / command flags (4)', $datum ] );
            ...
            push( @msgdata,
                [ '11:2', '(3Ah) Store Communication Event Command', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[11], '3' );
            push( @msgdata,
                [ '11:3', '(3Bh) Set Clock / Calendar Command', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[11], '4' );
            push( @msgdata,
                [ '11:4', '(3Ch) Primary Keypad Function with PIN', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[11], '5' );
            push( @msgdata,
                [ '11:5', '(3Dh) Primary Keypad Function without PIN', $datum ]
            );
        ...
        sub parse_04H {
            ...
            $datum = &caddx::parse::getbits( $msgb[7], '0' );
            push( @msgdata,
                [ '7:0', '{faulted} Faulted (or delayed trip)', $datum ] );
        ...
        sub parse_05H {
            ...
            push(
                @msgdata,
                [
                    '3:2', 'Zone 1 trouble (tamper, low battery, or lost)',
                    $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[3], '3' );
            ...
            push(
                @msgdata,
                [
                    '3:6', 'Zone 2 trouble (tamper, low battery, or lost)',
                    $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[3], '7' );
            ...
            push(
                @msgdata,
                [
                    '4:2', 'Zone 3 trouble (tamper, low battery, or lost)',
                    $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[4], '3' );
            ...
            push(
                @msgdata,
                [
                    '4:6', 'Zone 4 trouble (tamper, low battery, or lost)',
                    $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[4], '7' );
            ...
            $datum = $msgb[10];
            push( @msgdata,
                [ '10:', 'Zone 15 & 16 (+offset) status flags', $datum ] );
        ...
        sub parse_06H {
            ...
            push(
                @msgdata,
                [
                    '2:', '{hex_partition} Partition number (0= partition 1)',
                    $datum
                ]
            );
            ...
            $datum = &caddx::parse::getbits( $msgb[9], '7' );
            push( @msgdata,
                [ '9:7', 'Delay Trip in progress (common zone)', $datum ] );
            $msghash{_parsed_} = \@msgdata;    # stash verbose parse
            return \%msghash;                  # send back a hash ref to all
        }
        ##################################################
        ...
        sub parse_08H {
            ...
            $datum = &caddx::parse::getbits( $msgb[5], '4' );
            push( @msgdata,
                [ '5:4', 'Expander auxiliary output over current', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[5], '5' );
            push( @msgdata,
                [ '5:5', 'Auxiliary communication channel failure', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[5], '6' );
            ...
            $datum = &caddx::parse::getbits( $msgb[6], '7' );
            push( @msgdata,
                [ '6:7', 'Bus device has requested sniff mode', $datum ] );
            $datum = $msgb[7];
            ...
            $datum = &caddx::parse::getbits( $msgb[7], '4' );
            push( @msgdata,
                [ '7:4', 'Fire alarm verification being timed', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[7], '5' );
            ...
            $datum = &caddx::parse::getbits( $msgb[7], '7' );
            push( @msgdata,
                [ '7:7', 'Timing a high voltage battery charge', $datum ] );
            $datum = $msgb[8];
        ...
        sub parse_09H {
            ...
            $datum = $msgb[4];
            push( @msgdata,
                [ '4:', 'X-10 function code (see table that follows)', $datum ]
            );
            $msghash{_parsed_} = \@msgdata;    # stash verbose parse
            return \%msghash;                  # send back a hash ref to all
        }
        ...
        sub parse_0AH {
            ...
            push(
                @msgdata,
                [
                    '3:', 'Total log size (number of log entries allowed)',
                    $datum
                ]
            );
            $datum = $msgb[4];
            ...
            push(
                @msgdata,
                [
                    '4:0-6', 'See type definitions in table that follows',
                    $datum
                ]
            );
            $datum = &caddx::parse::getbits( $msgb[4], '7' );
            ...
            push(
                @msgdata,
                [
                    '6:', 'Partition number (0=partition 1, if relevant)',
                    $datum
                ]
            );
            $datum = $msgb[7];
        ...
        sub parse_10H {
            ...
            push(
                @msgdata,
                [
                    '5:0-4', 'Number of segments in location (0=1 segment)',
                    $datum
                ]
            );
            ...
            push(
                @msgdata,
                [
                    '5:5-7', 'Data type : 0=Binary,1=Decimal,2=Hex,3=Asc',
                    $datum
                ]
            );
            $datum = $msgb[6];
        ...
        sub parse_12H {
            ...
            $datum = &caddx::parse::getbits( $msgb[5], '0-3' );
            push( @msgdata,
                [ '5:0-3', 'PIN digit 5 (pad with 0 if 4 digit PIN)', $datum ]
            );
            $datum = &caddx::parse::getbits( $msgb[5], '4-7' );
            push( @msgdata,
                [ '5:4-7', 'PIN digit 6 (pad with 0 if 4 digit PIN)', $datum ]
            );
            $datum = $msgb[6];
            push( @msgdata,
        ...
        sub parse_PSNAP {
            ...
            $datum = $msgb[1];
            push( @msgdata,
                [ '1:', 'Partition snapshot layout (msg 07h detail)', $datum ]
            );
        ...
        sub parse_ZSNAP {
            ...
            $datum = $msgb[1];
            push( @msgdata,
                [ '1:', 'Zone snapshot nibble (msg 05h detail)', $datum ] );
            $datum = &caddx::parse::getbits( $msgb[1], '0' );
            push( @msgdata,
            ...
            push(
                @msgdata,
                [
                    '1:2', 'Zone {trouble} (tamper, low battery, or lost)',
                    $datum
                ]
            );
            $msghash{trouble} = $datum;
