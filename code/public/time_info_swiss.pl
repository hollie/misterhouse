...
speak "Gender=male Voice=8 Sonnenaufgang ist heute $Time_Sunrise, Sonnenuntergang ist $Time_Sunset."
  if said $v_sun_set;
...
speak "rooms=all Gender=male Voice=3 Mitteilung, die Sonne geht jetzt unter $Time_Sunset"
