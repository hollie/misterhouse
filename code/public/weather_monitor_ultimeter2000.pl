...
$YesterdayOutdoorLowHumidityTime  = new Weather_Item("YesterdayOutdoorLowHumidityTime");
$LongtermOutdoorLowHumidityDate   = new Weather_Item("LongtermOutdoorLowHumidityDate");
$LongtermOutdoorLowHumidity       = new Weather_Item("LongtermOutdoorLowHumidity");
$LongtermOutdoorLowHumidityTime   = new Weather_Item("LongtermOutdoorLowHumidityTime");
...
$TodayOutdoorHighHumidityTime     = new Weather_Item("TodayOutdoorHighHumidityTime");
$YesterdayOutdoorHighHumidity     = new Weather_Item("YesterdayOutdoorHighHumidity");
$YesterdayOutdoorHighHumidityTime = new Weather_Item("YesterdayOutdoorHighHumidityTime");
$LongtermOutdoorHighHumidityDate  = new Weather_Item("LongtermOutdoorHighHumidityDate");
$LongtermOutdoorHighHumidity      = new Weather_Item("LongtermOutdoorHighHumidity");
$LongtermOutdoorHighHumidityTime  = new Weather_Item("LongtermOutdoorHighHumidityTime");
