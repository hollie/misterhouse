...
sub main::get_oscar_connection {
    ...
    $im_connection =
      Net::OSCAR->new( capabilities => [ qw(typing_status extended_status buddy_icons file_transfer                    ) ] );
...
sub main::net_im_send {
    ...
    &::logit( "$main::config_parms{data_dir}/logs/net_im.$::Year_Month_Now.log",
