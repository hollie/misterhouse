...
my (
    @xap_item_names, $started,  $xap_listen,          $xap_hub_listen,     $xap_send,
    %hub_ports,      %xap_uids, %xap_virtual_devices, $xap_hbeat_interval, $xap_hbeat_counter,
    @send_queue,     %timeouts, $send_queue_timeout
);
use vars '$xap_data';
