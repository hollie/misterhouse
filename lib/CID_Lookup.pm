...
sub formated_number
{
	...
	$$self{m_CIDFormatedNumber}=$p_CIDFormatedNumber if defined $p_CIDFormatedNumber;
...
sub speakable_number
{
	...
	$$self{m_CIDSpeakableNumber}=$p_CIDSpeakableNumber if defined $p_CIDSpeakableNumber;
