...
sub process {
    ...
    my (
        $indoor_temp,      $outdoor_temp, $wind_speed, $wind_direction, $barometer, $indoor_humidity,
        $outdoor_humidity, $total_rain,   $not_used,   $crc16,          $rain_rate
    );
    ...
    while ( defined( $headerByte = shift(@data) ) ) {
        ...
        (
            $indoor_temp,     $outdoor_temp,     $wind_speed, $wind_direction, $barometer,
            $indoor_humidity, $outdoor_humidity, $total_rain, $not_used,       $crc16
