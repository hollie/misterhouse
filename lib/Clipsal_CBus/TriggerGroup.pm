...
=head1 B<Clipsal CBus Trigger Group>
 
=head2 SYNOPSIS
 
TriggerGroup.pm - support for Clipsal CBus trigger groups.
 
=head2 DESCRIPTION
 
This module is a child of Clispal_CBus. It provides a MisterHouse object
that corresponds to a CBus trigger group, with a set() method that overides
that inherited from it's GenericItem parent.
 
=cut

package Clipsal_CBus::TriggerGroup;
...
@Clipsal_CBus::TriggerGroup::ISA = ( 'Generic_Item', 'Clipsal_CBus' );

=item C<new()>
 
 Instantiates a new CBus trigger group object.
...
=item C<set(state, set_by, respond)>
 ...
 The CBus syntax is: "TRIGGER" SP "EVENT" SP trigger-group-address SP action-selector
