...
my %funcs = (
    ...
    '10',             'A',          '11',            'B',             '12',            'C',
    '13',             'D',          '14',            'E',             '15',            'F',
    '16',             'G',          'All Lights On', 'O',             'All Units Off', 'P',
    'On',             'J',          'Off',           'K',             'Bright',        'L',
    'Dim',            'M',          'Preset Dim 0',  'PRESET_DIM1',   'Preset Dim 1',  'PRESET_DIM2',
    'All Lights Off', 'P',          'Extended Code', 'EXTENDED_CODE', 'Hail Request',  'HAIL_REQUEST',
    'Hail Ack',       'HAIL_ACK',   'Extended Data', 'EXTENDED_DATA', 'Status On',     'STATUS_ON',
