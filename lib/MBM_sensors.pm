...
##
    ...
    for ( $i = 0; $i < $SensorTotalCount; $i++ ) {
        my ( $ssType, $ssName, $ssCurrent, $ssLow, $ssHigh, $ssCount, $ssTotal, $ssAlarm1, $ssAlarm2 ) =
    ...
    my ( $siSMB_Base, $siSMB_Type, $siSMBCode, $siSMB_Addr, $siSMB_Name, $siISA_Base, $siChipType, $siVoltageSubType ) =
