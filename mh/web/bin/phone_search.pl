...
$header  .= qq[<table><tr><form action='/bin/phone_search.pl'><td>Search String:</td><td><input align='left' size='25' name='search' value='$string'></td></form></tr></table>];
$results .= qq[
