...
#    $Mp3List = "$Mp3List document.write('coookie=' + ListON+'!');";    
    ...
    $Mp3List = "$Mp3List<TR><th><small>Track<br>(<u>del</u>)</small></th><th><small>Song Title<br>(<u>jump</u>)</small></th><th><small>Play<br>Time</small></th></TR><small>";
...
#								    </td><td><a target='invisi'href='$serv/SUB:mp3_set_playlist_pos(%22$my_pos%22)'>$item</a></td><td>$Time</td></tr>" ; }
		if ( $pos - 1 != $currPos ) { $Mp3List = $Mp3List ."<tr><td id=$pos><a href='javascript:remove($my_pos)'> $pos </a>\
