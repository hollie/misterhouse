...
|;
    ...
    opendir(MYDIR, $config_parms{code_dir_common}) or return "Error, can not open directory $config_parms{code_dir_common}.\n";
...
sub select_code_update {
  ...
  $html .= "<b>The following code were deleted:  </b><P><PRE>$modules_deleted</PRE>" if $modules_deleted;
