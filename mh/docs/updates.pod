...
=head2 mh ver 1.95 posted on 01/23/00

Version 1.95 was just uploaded to:

  http://misterhouse.net/download
  http://sourceforge.misterhouse.net/download


New Features:

- Moved the mh CVS repository to sourceforge.net.  This doesn't affect most of you, but if anyone
else wants to get involved in updating core mh code, let me know and I'll send you a howto note.
...
- Added mh/code/public/callerid.pl as another, more simple example on how to do callerid with a modem.
