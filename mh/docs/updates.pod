...
<a href=http://misterhouse.net/mh/docs/updates.html>here, in the test release updates file</a>.
...
- Stéphane Kattoor created code/common/ical.pl to allow for control of mh items from any ICal application
...
- Created a MisterHouse Fraper map, so we can see where we all are:  http://www.frappr.com/misterhouse
...
- Neil Cherry updated FAQ 2.15: What is the format of MisterHouse X10 codes?

- Ben Raymond updated iButton.pm to adds (partial) support for DS2409 one-wire net couplers.
...
- David Norwood updated faq 2.15: What is the format of MisterHouse X10 codes?
...
- Rick Steeven created code/public/internet_internet_usgs.pl for monitoring the water level of
