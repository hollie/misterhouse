...
- Doug suggested a get_email enhancement that allows for browsing mh monitored email from
...
- Danel Estes noted that Serial_Items without defined state strings returned 'default_state'.  
...
and pointed it to Danel Estes's Family Radio Service FAQ mh/docs/faq_frs.html.
...
- Added  Kevin O.'s fix to CM11.pm to fix the problem he was having with not receiving all incoming X10 signals.
...
- Added  David L.'s linux mp3 control code as code to mh/code/public/mp3_control_GQmpeg.pl.
...
- Included  Craig S.'s sump pump code  and Tom's news_* code to mh/code/public.
...
- Added  Tom K.'s $Time_Of_Day global var (morning, afternoon, evening, and night)
...
- Moved  Brian K's code from mh/code/public to mh/code/public/Brian.  Added  Mike M's webcam code.
