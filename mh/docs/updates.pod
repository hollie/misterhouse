...
- Amauri Viguera added support for integrating mh with HTPC (Home Theater PC menuing program for TVs). 
Details are here: http://www.viguera.net/other/projects/myhtpc/myhtpc.readme.html

- Pete Flaherty and Ross Towbin added SMTP authenticaion for email checking.  Set a new net_mail_*_password_encryp mh.ini option.
...
- Sean Walker and I updated common/internet_logon.pl to use a new %Flags hash to control
what commands to fire when getting internet data.  Now used in stocks.pl.

- David Norwood created a new trigger function, used to control internet data commands ....
