...
- Added mh/lib/site/Date/Manip.pm and Manip.txt.  This large module took and extra .5 seconds and 3 meg
of memory to load, so I decided not to load it by default.  See mh/code/examples/test_dates.pl
...
- Jason Sharpe and I added several new methods: Generic_Item get_idle_time  and
