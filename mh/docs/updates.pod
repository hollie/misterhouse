...
messages is at http://sourceforge.net/mail/?group_id=1365 )

=head2 Version 2.30 posted on 10/??/00

Version 2.30 was just uploaded to:
...
- Added memory on NT and mh/code/common/monitor_memory.pl

- Added volume to speak and play, but currently only works on windows.
Defaults to a new mh.ini sound_volume parm.
...
- Added mh.ini code_dir_system dir, like code_dir, but for common code files.  
Moved the tk*, mh_control, mhsend_server, and benchmark .pl files into there.

- Added mh/lib/site/HTML/TableExtract.pm
...
- Added Kevin's mh/code/public/x10_ma26.pl code for monitoring the X10 wireless mouse receiver.
...
- Craig S. added a iButton read_switch method, for the DS2407 switch.  He also has started on
...
- Added Kevin's fix to CM11.pm to fix the problem he was having with not receiving all incoming X10 signals.
...
- Added David's linux mp3 control code as code to mh/code/public/mp3_control_GQmpeg.pl.
...
mh/public/calllog.pl code that Brian and Ernie O. put together.  The phone_modem.pl code is a bit 
...
- Added Tom's $Time_Of_Day global var (morning, afternoon, evening, and night)
...
- Dave Lounsberry and I re-vamped the web interface.
...
- Added Dave L.'s motion sensor code as code/examples/x10_motion_sensors_dave.pl
