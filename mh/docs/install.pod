...
You can download the required files from the 4.0 SDK from here:   http://www.microsoft.com/downloads/release.asp?ReleaseID=26299
...
Or you can avoid the installing the whole SDK by downloading just the required files
