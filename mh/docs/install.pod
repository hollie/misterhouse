...
If the DB_File post-install script doesn't run to install the included libdb.dll 
(the DB_File.dll should already be copied ok), you can extract the dll
from http://theoryx5.uwinnipeg.ca/ppms/x86/DB_File.tar.gz and copy it to your 
 \perl\site\lib\auto direcotory, or some other directory in your path.
