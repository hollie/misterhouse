...
=head 1.16 Is there a front-end tool for defining/editing mh items/events?
...
but other formats (e.g. xml) should be real easy to implement.
...
in early '94.  He loves getting slaughtered by his twin boys in Quake death matches, hiking
in his boyhood state of Montana, and playing his digital piano.
