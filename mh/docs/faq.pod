...
telnet sessions (if running mh/code/test/telent.pl), and via the built in web server.  An example url
...
Out of the box, mh defaults to running all the code in the mh/code/test directory.  
