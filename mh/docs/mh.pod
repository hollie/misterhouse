...
The SET_VAR command can set a variable or an object (child of Generic_Object) to any arbitrary value.
...
Here are some examples demonstrating these options:
 ...
 that was updated by user code:
  ...
  <FORM ACTION="SET_VAR:barcode_search.html"  target='speech'>
