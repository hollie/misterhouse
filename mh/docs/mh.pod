...
Here are some urls and prices:
  ...
  http://www.ibutton.com (pick shop online)
    - $15 DS9097U-009 + DS1402D-DR8l for the serial interface
...
All other items that have states (e.g. X10_Item, Serial_Item, iButton, Voice_Cmd) inherit all Generic_Item methods.
...
Windows Activestate perl 5.6 build 613 leaks memory.  On my box about 30 Meg a day. 
