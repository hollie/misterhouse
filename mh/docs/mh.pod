...
with a nice collection of links, resources, notes and commentary.
...
The W800  is $50 from http://www.wgldesigns.com/w800.html .
...
is it is much faster as data goes from RF -> MR26A/W800 -> serial_port -> mh.   
...
In all cases, methods light and dark will return the current light/dark state.  For example:
