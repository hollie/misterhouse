...
too popular.  I wrote the module for the UIRT2 and it is being used by a few
on both Windows and Linux.  I'm also working on a module for the USB-UIRT,
but haven't finished it yet (sorry Jason and Bill).  I've only gotten it to
work on Linux.  The Ocelot is another option.
