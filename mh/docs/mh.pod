...
use the codes for your various remotes.  
  ...
  Methods:
     new $type    : Creates a new Item.  Here are the valid types:
...
Note that the X10 device code is numbered 1->9,A->F.  For example device 16 in house code P would be PF.
