...
$v_wakeup_time = new  Voice_Cmd("Wakeup Time Is Set To [3:30 AM,4:00 AM,4:30 
...
offline mode
    &speak(wakeup_time => 'unmuted', rooms => 'all', text => "MisterHouse is 
...
or
    ...
    &pa_sleep_mode('all', 0);
    speak("rooms=bedroom Good morning Parents.  It is now $Time_Now on 
$Date_Now_Speakable.");
    speak("rooms=bedroom Sunrise today is at $Time_Sunrise, sunset is at 
$Time_Sunset");
}     
