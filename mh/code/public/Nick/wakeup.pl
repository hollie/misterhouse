...
&tk_radiobutton('Wakeup Time',  \$Save{wakeup_time}, ['6 am', '6:15 am', '6:30 am', '6:45 am', '7 am']);

$v_wakeup_nick   = new  Voice_Cmd('Wakeup Nick');

if ((time_now($Save{wakeup_time}) and $Weekday) or
    said $v_wakeup_nick) {
...
run_voice_cmd 'set mp3 player to play' if time_now '3:30 pm' and $Weekday;
