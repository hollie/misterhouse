...
speak (mode=>'unmuted', volume=>50,  text=>"rooms=Office This message in Office Only") if said $v_to50;
speak (mode=>'unmuted', volume=>100, text=>"rooms=Office This message in Office Only") if said $v_to100;
