...
run_voice_cmd 'Set house mp3 player to Volume up' if ($key eq 'CD-Volume-up');
run_voice_cmd 'Set house mp3 player to Volume down' if ($key eq 'CD-Volume-down');
run_voice_cmd 'Set house mp3 player to Next Song' if ($key eq 'CD-Next-Song');
run_voice_cmd 'Set house mp3 player to Previous Song' if ($key eq 'CD-Previous-Song');
run_voice_cmd 'Set house mp3 player to Next Song' if ($key eq 'CD-FForward');
run_voice_cmd 'Set house mp3 player to Previous Song' if ($key eq 'CD-Rewind');
...
run_voice_cmd 'Toggle recording of TV programme' if ($key eq 'TV Record');
run_voice_cmd 'Play recorded file' if ($key eq 'TV Red');
run_voice_cmd 'Set the house video player to Off' if ($key eq 'VCR-Exit');
run_voice_cmd 'Play recorded file' if ($key eq 'VCR Red');
run_voice_cmd 'Toggle recording of TV programme' if ($key eq 'VCR-Record');
...
run_voice_cmd 'Set house mp3 player to Pause' if ($key eq 'VCR-Pause');
run_voice_cmd 'Set the house video player to Volume up' if ($key eq 'VCR-Volume-up');
run_voice_cmd 'Set the house video player to Volume down' if ($key eq 'VCR-Volume-down');
run_voice_cmd 'Set the house video player to Mute' if ($key eq 'VCR-Mute');
run_voice_cmd 'Set the house video player to Off' if ($key eq 'VCR-Exit');
run_voice_cmd 'Set house mp3 player to Next Song' if ($key eq 'VCR-Next-Song');
run_voice_cmd 'Set house mp3 player to Previous Song' if ($key eq 'VCR-Previous-Song');
...
run_voice_cmd 'Set the house video player to Full screen' if ($key eq 'VCR-Full-screen');
...
run_voice_cmd 'Set Radio Volume down' if ($key eq 'RADIO Volume down');
