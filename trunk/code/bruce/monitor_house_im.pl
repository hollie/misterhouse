...
&send_im_work("Last reported: " . state $monitor_vehicles) if expired $monitor_vehicles_timer;
...
&send_im_work("Hello from home at $Date_Now") if said $test_ping_work or ($Weekday and time_now '12 pm');

                                # Test sending html
$test_ping_work2 = new Voice_Cmd 'Ping work 2';
&send_im_work(qq|Motion detected:
