...
sub laundry_reminder {
    my @laundry_reminders = 
      ('are ready for enlightenment', 'are seeking proof of lint', 'would like to hire a maid',
       'think you have fallen asleep', 'are done with timeout', 'would like to play in the mud',
       'have hired a hit man for that stupid snuggly bear', 'think fabric softeners are for little girls',
       'have burned up on reentry', 'are lost in the Bermuda triangle', 'are eating spaghetti', 
       'just saw Elvis', 'just turned into that ugly guy from Threes Company', 'are having dinner', 
