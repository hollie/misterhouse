...
#       $html .= "<li><a href=http://www.barpoint.com/frame.cfm?UPCNumber=$code>BarPoint: Most anything</a>\n";
        ...
        $html .= "<li><a href=http://wwwapps.ups.com/etracking/tracking.cgi?tracknums_displayed=5" .
                 "&TypeOfInquiryNumber=T&HTMLVersion=4.0&InquiryNumber1=$code>UPS Tracking</a>\n";
        $html .= "<li><a href=http://fedex.com/cgi-bin/tracking?action=track&language=english&cntry_code=us " .
