...
if ($Save{mode} eq 'mute' and  $Save{mode_set} eq 'auto' and
    (time_cron '0,15,30,45 6-21 * * 1-5' or
     time_cron '45 5 * * 1-5' or
...
or time_cron('0 10 * * 0,6' )or said $v_wakeup) {
