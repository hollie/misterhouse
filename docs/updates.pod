...
- Matthew Williams migrated the MisterHouse sourceforge repository from CVS to subversion.

- Gaetan Lord and Matthew Williams added virtual_keyboard.pl to allow for a virtual keyboard within a web page,
